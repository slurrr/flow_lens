...
def _load_config_summary(path: Path) -> dict[str, object]:
    ...
    ordered_keys = [
        ...
        "dist_state_p_availability_mode",
        "dist_state_oi_poll_interval_ms",
        "dist_state_oi_tolerance_ms",
        "dist_state_oi_time_missing_policy",
        "dist_state_oi_verify_enabled",
        "dist_state_oi_verify_timeframes",
        "dist_state_oi_verify_timeout_ms",
        "dist_state_oi_verify_max_rate_per_min",
        "dist_state_oi_quality_window_ms",
        ...
        "dist_state_k_p",
        "dist_state_k_t",
        "dist_state_tokens_enabled",
        "dist_state_tokens_fail_fast_unknown",
        "dist_state_s_dir_deadband",
        "dist_state_s_ext_enter",
        "dist_state_s_ext_exit",
        "dist_state_s_revert_min_stretch",
        "dist_state_t_exp_enter",
        "dist_state_t_exp_exit",
        "dist_state_t_comp_enter",
        "dist_state_t_comp_exit",
        "dist_state_a_cont_enter",
        "dist_state_a_cont_exit",
        "dist_state_a_revert_enter",
        "dist_state_a_revert_exit",
        "dist_state_v_low_threshold",
        "dist_state_t_rise_threshold",
        "dist_state_s_neut_max",
        "dist_state_a_neut_max",
        "dist_state_t_neut_max",
        "dist_state_v_neut_min",
        "dist_state_v_neut_max",
        "dist_state_t_exp_plus",
        "dist_state_t_exp_plus_plus",
        "dist_state_t_comp_plus",
        "dist_state_t_comp_plus_plus",
        "dist_state_a_cont_plus",
        "dist_state_a_cont_plus_plus",
        "dist_state_a_revert_plus",
        "dist_state_a_revert_plus_plus",
        "dist_state_s_exh_plus",
        "dist_state_s_exh_plus_plus",
        "dist_state_p_confirm_threshold",
