...
Normalizing by rates and symbol-local scales produces a dimensionless, comparable effectiveness input while preserving the meaning: “Given who is dominant, is price moving in that direction per unit of effort?” Rate normalization keeps Δ invariant, and scale medians prevent notional magnitude from collapsing Y toward zero.
