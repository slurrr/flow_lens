...
- `s_ext_enter: float` (default `0.65`)
- `s_ext_exit: float` (default `0.55`)
- `s_revert_min_stretch: float` (default `0.25`)
- `t_exp_enter: float` (default `0.15`)
- `t_exp_exit: float` (default `0.10`)
- `t_comp_enter: float` (default `-0.18`)
- `t_comp_exit: float` (default `-0.12`)
- `a_cont_enter: float` (default `0.12`)
- `a_cont_exit: float` (default `0.08`)
- `a_revert_enter: float` (default `-0.12`)
- `a_revert_exit: float` (default `-0.08`)
- `v_low_threshold: float` (default `0.44`)
...
- strength cutoffs:
  - `t_exp_plus: float` (default `0.25`)
  - `t_exp_plus_plus: float` (default `0.35`)
  - `t_comp_plus: float` (default `-0.20`)
  - `t_comp_plus_plus: float` (default `-0.23`)
  - `a_cont_plus: float` (default `0.16`)
  - `a_cont_plus_plus: float` (default `0.24`)
  - `a_revert_plus: float` (default `-0.16`)
  - `a_revert_plus_plus: float` (default `-0.24`)
  - `s_exh_plus: float` (default `0.75`)
  - `s_exh_plus_plus: float` (default `0.85`)
- `p_confirm_threshold: float` (default `0.20`)
- per-timeframe dwell:
